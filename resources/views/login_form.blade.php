        ...
        <div class="row card1">
            <div class="col-12 card2">
                ...
                <form method="get" action="login">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="text" name="em" placeholder="Email" id="em1" class="form-control" value="{{old('em')}}">
                        </div>
                        <small>
                            @error('em')
                                {{$message}}
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="password" name="pwd" placeholder="Password" id="pwd1" class="form-control" value="{{old('pwd')}}">
                        </div>
